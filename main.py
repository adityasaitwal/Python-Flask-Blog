...
@app.route("/")
def home():
    flash("Read my posts below", "success")
    flash("Do follow me on Twitter,Facebook and GitHub,link is given at the bottom", "secondary")
...
def contact():
    if request.method == 'POST':
        ...
        entry = Contacts(Name=name, PhoneNo=phone, Mes=message, Date= datetime.now(), EmailID=email )
